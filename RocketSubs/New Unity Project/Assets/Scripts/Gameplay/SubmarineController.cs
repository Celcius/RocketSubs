...
public class SubmarineController : MonoBehaviour 
{
    ...
    private void UpdateFuel(bool isMoving)
    {
        if(onSea.Value)
        {
    ...
    private bool HandleBounce()
    {
        ...
        if(shouldBounce)
        {
            rotateSpeed = 0;
            rotateAccel = 0;
            Vector2 normalizedVec = body.velocity.normalized;
    ...
    private void UpdateSpeed()
    {
        ...
        bool movingForward = inputForward.Value && (onSea.Value || (fuel.Value > 0));
        Vector2 forward = GetForward();
